"""
Find the contiguous sufooray within an array (containing at least one number) which has the largest product.

For example, given the array [2,3,-2,4],
the contiguous sufooray [2,3] has the largest product = 6
"""
__author__ = 'yangxing'
