...
# -----------------------------------------------------------------------------------
# 对于python的异步写法,tornado提供了2种写法,分别是2个装饰器的使用：
#    1.类似于nodejs的callback写法 -->  @asynchronous
#    2.基于python自己的yield语法实现的coroutine写法 -->  @gen.coroutine + yield
# 弄懂tornado的这2个装饰器的使用写法,基本上就知道了python的异步/协程相关的东西了.
# -----------------------------------------------------------------------------------
