...
if __name__=="__main__":
    print Solution().ladderLength("sand", "acne", set(
        ["slit", "bunk", "wars", "ping", "viva", "wynn", "wows", "irks", "gang", "pool", "mock", "fort", "heel", "send",
         ...
         "russ", "pupa", "weed", "pulp", "main", "grim", "hone", "cord", "foof", "olav", "gaps", "rote", "wilt", "lars",
         ...
         "scat", "nice", "dart", "only", "owls", "hike", "trey", "whys", "ding", "klan", "ross", "foob", "ants", "lean",
         ...
         "pate", "vine", "zulu", "this", "fooe", "veal", "josh", "reek", "ours", "cowl", "club", "farm", "teat", "coat",
         ...
         "foos", "ride", "beck", "toad", "make", "head", "suds", "pike", "snot", "swat", "peed", "same", "gaza", "lent",
         ...
         "food", "limo", "shaw", "pint", "swim", "dust", "indy", "hale", "cats", "troy", "wens", "luke", "vern", "deli",
         ...
         "bate", "pitt", "como", "lyle", "siam", "rook", "baby", "jigs", "bret", "fook", "lori", "reba", "sups", "made",
         ...
         "nigh", "sony", "bide", "robs", "folk", "daft", "past", "blue", "flaw", "sana", "fits", "foor", "riot", "dots",
         ...
         "lear", "owns", "robt", "weds", "five", "lyon", "terr", "arno", "mama", "grey", "disk", "sept", "sire", "foot",
         ...
         "tits", "bork", "mils", "nary", "foon", "hype", "odom", "avon", "hewn", "rios", "cams", "tact", "boss", "oleo",
