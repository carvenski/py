...
if __name__=="__main__":
    ...
    assert Solution().findSubstring("lingmindraboofooowingdingfoorwingmonkeypoundcake", ["fooo","foor","wing","ding","wing"])==[13]
    assert Solution().findSubstring("foofoofoofoofooman", ["foo", "foo"])==[3, 6]
